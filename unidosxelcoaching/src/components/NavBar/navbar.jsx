                    ...
                    <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <Link to="/" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>Home</Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/quienesSomos" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>¿Quiénes somos?</Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/nuestraMision" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>Nuestra Misión</Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/eventosPresenciales" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>Eventos</Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/Servicios" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>Servicios</Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/Contacto" className={`nav-link ${StylesNavbar.navbar} ${StylesNavbar.text}`} onClick={handleNavLinkClick}>Contacto</Link>
                            </li>
                        </ul>
                    </div>
                </div>
